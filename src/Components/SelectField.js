...
const SelectField = (props) => {
    ...
    const customStyles = {
        control: (base, state) => ({
            ...
            border: props?.hideBorder ? '1px solid #cacaca' : '2px solid #393939',
            // marginBottom: "5px",
        ...
        dropdownIndicator: (base, state) => ({
            ...
            background: props.colorChange ? '#fff !important' : '#000 !important',
            color: state.isFocused && props.colorChange ? '#000' : props?.colorChange ? '#000' : '#fff',
            '&:hover': { color: '#D2D9E8' },
        }),
